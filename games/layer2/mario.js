window.initMario = function(container) {
    ...
    let princess = {
        x: LEVEL_END_X,
        y: 0, // Sera ajusté en fonction de canvas.height
        width: 100,
        height: 100
    };
    ...
    function update() {
        ...
        if (frameCount % 120 === 0 && cameraX < LEVEL_END_X - 600) { 
            spawnEnemy();
        }
    ...
    function triggerWinAnimation() {
        ...
        function winLoop() {
            ...
            ctx.fillText("ELIF SAUVÉE !", canvas.width/2, canvas.height/2);
            ctx.fillStyle = 'white';
            ctx.font = '20px Outfit';
            ctx.fillText("+1000 Points !", canvas.width/2, canvas.height/2 + 40);
